...
export const productDetail = {
  ...
  styleOptions: [
    { label: '原木色 / 1.3m', value: '原木色 / 1.3m', image: 'https://picsum.photos/seed/color1/50/50', tag: '热销' },
    { label: '原木色 / 1.5m', value: '原木色 / 1.5m', image: 'https://picsum.photos/seed/color1b/50/50' },
    { label: '胡桃色 / 1.3m', value: '胡桃色 / 1.3m', image: 'https://picsum.photos/seed/color2/50/50', disabled: true },
    { label: '胡桃色 / 1.5m', value: '胡桃色 / 1.5m', image: 'https://picsum.photos/seed/color2b/50/50' },
    { label: '白色 / 1.3m', value: '白色 / 1.3m', image: 'https://picsum.photos/seed/color3/50/50' },
  ],
  reviews: [
    {
      id: 1,
    ...
    },
    {
      ...
      append: {
        ...
        images: ['https://picsum.photos/seed/review4/200/200'],
      },
    },
    {
      id: 3,
